...
class StoreApp:
    ...
    def open_add_modal(self, page: ft.Page):
        """ULTRA SIMPLE TEST - No dropdowns, just text fields and category button"""
        
        import random
        import string
        
        print("=" * 50)
        print("ULTRA SIMPLE TEST - No dropdowns")
        print("=" * 50)
        ...
        category_btn = ft.ElevatedButton(
            ...
            on_click=lambda e: print("Category button clicked!"),
            style=ft.ButtonStyle(bgcolor=self.card_color, color=self.text_color),
        )
        
        # Form fields - NO DROPDOWNS
        ...
        def save_material(e):
            print(f"Save clicked - Name: {name_field.value}")
        ...
        dialog = ft.AlertDialog(
            title=ft.Text(""),
            content=ft.Container(content=scroll_content, width=dialog_width, height=450, padding=15),
            modal=True,
        )
